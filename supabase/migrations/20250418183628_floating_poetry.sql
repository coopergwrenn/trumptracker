/*
  ...
  1. Changes
    - Add parent_id, depth, and reply_count columns
    - Create indexes for efficient querying
    - Add function and trigger for reply count updates
    - Add optimized comment retrieval function

  2. Security
    - Maintain existing RLS policies
    - Add security definer function for safe comment retrieval
