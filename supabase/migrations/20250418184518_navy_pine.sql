/*
  # Fix ambiguous parent_id reference in comments query

  1. Changes
    - Drop and recreate get_paginated_comments function with explicit table references
    - Ensure proper ordering of comments by created_at
    - Maintain existing functionality while fixing the ambiguity

  2. Security
    - Function remains accessible to public role for comment retrieval
*/
